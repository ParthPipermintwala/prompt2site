    ...
    >
      {conversations.map((conversation, index) => (
        <Motion.div
          ...
          exit={{ opacity: 0, y: 40, transition: { duration: 0, delay: 0 } }}
          transition={{ duration: 0.3, delay: 0.1, ease: "easeInOut" }}
          className={`cursor-text group max-w-[80%] flex gap-1 ${conversation.role === "user" ? "justify-end ml-auto" : "justify-start mr-auto"}`}
        >
          <div
